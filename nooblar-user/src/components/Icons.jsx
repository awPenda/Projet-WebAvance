export default function Icons({ type }) {
    if (type == "trash_ico") {
        return (
            <div className="trash_ico accent_color_ico">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
            </div>
        );
    } else if (type == "info_ico") {
        return (
            <div className="info_ico main_color_ico">
    ...
    } else if (type == "warning_ico") {
        return (
            <div className="warning_ico accent_color_ico">
    ...
    } else if (type == "close_ico") {
        return (
            <div className="close_ico">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
            </div>
        );
    } else if (type == "notif_ico") {
        return (
            <div className="notif_ico">
    ...
    } else if (type == "home_ico") {
        return (
            <div className="home_ico main_color_fill_ico">
